...
public class FolderMe {
    ...
    public static String getVideoLoading(){
        return getExternalFolder("all") + "/loading_sound_effects.mp4";
    }
    
    public static String getVideoIntro(){
        return getExternalFolder("all") + "/video_intro.mp4";
    }
	...
	//WebServer Folder
	public static final String HOME_WEB_PATH = FOLDER_SCRIPTME + File.separator + "web";
    ...
    public static final String FOLDER_WEB_SERVER = HOME_WEB_PATH + "/server";
