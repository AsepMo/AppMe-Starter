...
import com.appme.story.engine.app.terminal.RootChecker;
...
public class CheckRootTask extends AsyncTask<Boolean, Integer, Boolean> {
    ...
    private final ProgressBar mBeerProgressView;
    ...
    public CheckRootTask(Context ctx, OnCheckRootFinishedListener listener, ProgressBar beerProgressView, ArrayList<ImageView> checkRootimageViewList) {
        mListener = listener;
    ...
    protected void onProgressUpdate(Integer... values) {
        ...
        mBeerProgressView.setProgress(value);
    ...
    protected void onPostExecute(Boolean isRooted) {
        ...
        mBeerProgressView.setProgress(100);
