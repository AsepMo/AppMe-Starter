    ...
    public MemoryTask startScanning() {
        ...
        new CountDownTimer(1000, 1000){
            ...
            public void onFinish() {  
                ...
                FileScanningTask appMe = new FileScanningTask(AppController.getContext(), AppMe.APPLIST_MEMORY, Storage.getInstance().getExternalStorageDirectory(), FileScanningTask.APK);
