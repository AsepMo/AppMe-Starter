...
public class BinaryInstallerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_appme_installation, container, false);
        return rootView;
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (statusKey) {
                case "check_index_file":
                    ...
                    mLoading0.setLoadingIcon(R.drawable.ic_loading);
                ...
                case "extract_assets_to_storage":
                    mLoading1.setLoadingText("Waiting for Install");
                    mLoading1.setLoadingIcon(R.drawable.ic_loading);
                    mLoading1.setCurrentStatus(statusData);
                    mLoading1.setCurrentLine("Please wait.."); 
                    mSteppers[0].nextStep();
                    AssetManager mAssetManager = AssetManager.with(mContext);
                    mAssetManager.init();
                    mAssetManager.setStartActivity(new AssetManager.OnStartActivityListener(){
                            @Override
                            public void onStart() {                                
                ...
                case "syncron_index_file":
                    ...
                    mLoading2.setLoadingIcon(R.drawable.ic_loading);
                ...
                case "start_activity":
                    ...
                    mLoading3.setLoadingIcon(R.drawable.ic_loading);
