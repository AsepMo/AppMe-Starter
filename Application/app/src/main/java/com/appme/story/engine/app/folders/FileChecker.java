...
public class FileChecker {
    ...
    public static void extract(InstallService installService) {
        AssetManager mAssetManager = AssetManager.with(AppController.getContext());
        mAssetManager.extract(installService);
    }
