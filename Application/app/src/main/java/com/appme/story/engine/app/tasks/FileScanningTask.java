...
public class FileScanningTask extends AsyncTask<File, String, ArrayList<AppMe>> {

    public static final String TAG = FileScanningTask.class.getSimpleName();
    
    private Context mContext;
    private ArrayList<AppMe> appList;
    private AppMe mAppMe;
    private int count = 0; 
    ...
    public FileScanningTask(Context context, String fileName, String filePath, String ext) {
        ...
        mAppMe = new AppMe(context, fileName);  
    }
    ...
    @Override
    protected void onCancelled(ArrayList<AppMe> result) {
        super.onCancelled(result);
    }

    @Override
    protected void onPostExecute(ArrayList<AppMe> result) {
